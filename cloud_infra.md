...
| ESXi                      | Name (or type) of the VMware hypervisor used in the Company ABC cloud environment. The ESXi hypervisor is the layer that separates the host machine from the virtual computer (or guest machine). |
...
ALL REMAINING CONTENT REDACTED
